...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1535564465;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        95 => wire__crate__api__identity__reset_backup_confirmation_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        96 => wire__crate__api__orders__restart_orders_subscription_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        97 => wire__crate__api__orders__send_fiat_sent_impl(port, ptr, rust_vec_len, data_len),
        98 => wire__crate__api__messages__send_file_impl(port, ptr, rust_vec_len, data_len),
        99 => wire__crate__api__orders__send_invoice_impl(port, ptr, rust_vec_len, data_len),
        100 => wire__crate__api__messages__send_message_impl(port, ptr, rust_vec_len, data_len),
        101 => wire__crate__api__settings__set_active_mostro_node_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
